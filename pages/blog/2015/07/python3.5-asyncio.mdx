...
asyncioで導入された**コルーチン**というやつの正体は、結局のところジェネレータのようです。去年[ジェネレータでグリーンスレッドもどき](/blog/2014/08/yield-green-thread.html)を作りましたが、あれと思想は似ているみたい。
