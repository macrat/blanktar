...
pubtime: 2020-05-03T13:21+0900
amp: hybrid
tags: [gandi, クレジットカード, セキュリティ, ドメイン]
...
[gandi.net](https://gandi.net)にクレジットカードを登録するときに転送される「na.gcsip.com」ってサイトは、多分大丈夫なやつです。
...
発行先は「Global Collect Services B.V.」ってところ。これ、[ingenicoグループ](http://ingenico.co.jp/)って会社の傘下みたいですね。

さらに調べてみたところ、公式ツイッターとユーザのやり取りを見つけました。
