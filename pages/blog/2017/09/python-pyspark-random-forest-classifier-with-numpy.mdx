...
pubtime: 2017-09-14 15:40
tags: [python, pyspark, spark, numpy, RandomForest, RandomForestClassifier]
---

<PS date="2017-09-15">
<a href="/blog/2017/09/python-scikit-learn-random-forest.html">scikit-learnを使って同じことをする記事</a>も書きました。比べてみると面白いかも？
</PS>
...
![irisの分類結果のプロット](/blog/2017/09/pyspark-randomforest-predict-plot.png)
